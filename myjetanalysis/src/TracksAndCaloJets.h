#ifndef TRACKSANDCALOJETS_H
#define TRACKSANDCALOJETS_H
...
class TracksAndCaloJets : public SubsysReco
{
 public:
  TracksAndCaloJets(
      ...
      const std::string &outputfilename = "TracksAndCaloJets.root");

  const double min_calo_pt;
  virtual ~TracksAndCaloJets();
